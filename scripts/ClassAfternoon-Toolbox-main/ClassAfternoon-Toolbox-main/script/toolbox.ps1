try {
    ...
    #---init>gui-util
        ...
        $objIcon = New-Object system.drawing.icon ("$RootPath\teamwork.ico")
        $GifFile_CompBackground= (Get-Item -Path "$RootPath\gears.gif")
    ...
    $Gif_CompBackground = New-Object Windows.Forms.picturebox -Property @{
        ...
        AutoSize = $true
        Size = New-Object System.Drawing.Size(120,120)
    ...
    $lblMainMenu = New-Object System.Windows.Forms.Label -Property @{
        Location = New-Object System.Drawing.Point(110,25)
    ...
    $btnCreate = New-Object System.Windows.Forms.Button -Property @{
        ...
        Size = New-Object System.Drawing.Size(145,60)
        ForeColor = $json.ToolUILabelColor
        BackColor = $json.ToolUIBtnColor
        Text = 'CREATE'      
    }
