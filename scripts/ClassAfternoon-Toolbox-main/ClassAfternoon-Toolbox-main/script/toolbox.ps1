try {
    ...
    $InsertIcon = New-Object System.Drawing.Icon "$RootPath\teamwork.ico"
    $form.Icon = $InsertIcon

    $InsertGif = (Get-Item -Path "$RootPath\gears.gif")
    $img = [System.Drawing.Image]::fromfile($InsertGif)

    $box = New-Object Windows.Forms.picturebox -Property @{
        Size = New-Object System.Drawing.Size(90,90)
        SizeMode = [System.Windows.Forms.PictureBoxSizeMode]::StretchImage
        Location = New-Object System.Drawing.Point(185,275)
        Image = $img
    }
    $InsertIcon = New-Object System.Drawing.Icon "$RootPath\teamwork.ico"
    $form.Icon = $InsertIcon
    ...
    $lblMainMenu = New-Object System.Windows.Forms.Label -Property @{
        Location = New-Object System.Drawing.Point(120,30)
        Size = New-Object System.Drawing.Size(280,22)
    ...
    $btnCreate = New-Object System.Windows.Forms.Button -Property @{
        Location = New-Object System.Drawing.Point(85,95)
        Size = New-Object System.Drawing.Size(125,50)
        ForeColor = $json.ToolUILabelColor
        BackColor = $json.ToolUIBtnColor
        Text = 'CREATE'      
    ...
    $btnRead = New-Object System.Windows.Forms.Button -Property @{
        Location = New-Object System.Drawing.Point(250,95)
        Size = New-Object System.Drawing.Size(125,50)
        ForeColor = $json.ToolUILabelColor
        BackColor = $json.ToolUIBtnColor
        Text = 'READ'      
    ...
    $btnUpdate = New-Object System.Windows.Forms.Button -Property @{
        Location = New-Object System.Drawing.Point(85,180)
        Size = New-Object System.Drawing.Size(125,50)
        ForeColor = $json.ToolUILabelColor
        BackColor = $json.ToolUIBtnColor
        Text = 'UPDATE'      
    ...
    $btnDelete = New-Object System.Windows.Forms.Button -Property @{
        Location = New-Object System.Drawing.Point(250,180)
        Size = New-Object System.Drawing.Size(125,50)
        ForeColor = $json.ToolUILabelColor
        BackColor = $json.ToolUIBtnColor
        Text = 'DELETE'      
